...
class PostMessagesViewTestCase(TestCase, LogInTester):
    ...
    def test_get_post_messages_without_being_a_member_or_applicant(self):
    ...
    def test_get_post_messages_of_invalid_club(self):
        self.client.login(username=self.owner.username, password='Password123')
        officer_count_before = Post.objects.count()
        url = reverse('post_messages', kwargs={'club_id': self.club.id+9999})
